    ...
    <main className="flex-grow pt-32 pb-24 px-margin-mobile md:px-margin-desktop max-w-[1440px] mx-auto w-full relative z-10">
      ...
      <header className="mb-16 text-center md:text-left">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
          Stay updated with the latest in 4K streaming technology, new channel additions, and guides to optimize your bexytv experience.
        </p>
      </header>
      ...
      <section className="bg-white border border-black/10 rounded-2xl p-8 md:p-16 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <form className="flex flex-col sm:flex-row gap-4 justify-center" onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <button
              className="bg-gradient-to-r from-primary-container to-secondary-container text-[#0F172A] font-title-md text-title-md px-8 py-3 rounded-lg whitespace-nowrap hover:opacity-90 transition-opacity"
              type="submit"
            >
              Subscribe
            </button>
